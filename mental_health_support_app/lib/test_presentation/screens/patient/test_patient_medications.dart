...
//                               ),
//                               decoration: BoxDecoration(
//                                 color: _primaryBlue.withOpacity(0.14),
//                                 borderRadius:
...
class TestPatientMedications extends StatefulWidget {
  ...
  @override
  State<TestPatientMedications> createState() => _TestPatientMedicationsState();
}
...
class _TestPatientMedicationsState extends State<TestPatientMedications> {
  ...
  Future<void> _load() async {
    setState(() => _loading = true);
    try {
      _prescription = await PatientController.getActivePrescription(
        widget.user.uid,
      );
    } catch (e) {
      debugPrint('Medications load error: $e');
