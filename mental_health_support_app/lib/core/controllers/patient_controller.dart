...
class PatientController {
  ...
  static Future<void> updateSleep(String patientUid, String sleepHours) async =>
      await PatientService.updateSleep(patientUid, sleepHours);

  static Future<void> updateMedication(String patientUid, bool taken) async =>
      await PatientService.updateMedication(patientUid, taken);

  static Future<void> saveDiaryEntry(String patientUid, String content) async =>
  ...
  static Future<void> updateDiaryEntry(String entryId, String content) async =>
