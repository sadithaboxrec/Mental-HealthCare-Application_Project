...
class GuardianController {
  ...
  static Future<Map<String, dynamic>?> getTodayLog(String guardianUid) async =>
      await GuardianService.getTodayLogPublic(guardianUid);

  static Future<Prescription?> getPatientPrescription(
    String patientUid,
  ) async => await GuardianService.getPatientActivePrescription(patientUid);

  static Future<Appointment?> getPatientNextAppointment(
    String patientUid,
  ) async => await GuardianService.getPatientNextAppointment(patientUid);
