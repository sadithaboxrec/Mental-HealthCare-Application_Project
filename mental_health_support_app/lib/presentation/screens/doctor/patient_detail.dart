                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          maxLines: 3,
                          decoration:
                              _inputDecoration('Enter clinical notes...'),
                        ),
                      ],
                    ),
                  ),
  ...
  Widget _timeChip({
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selected
              ? _kBlue.withValues(alpha: 0.12) // fixed
            ...
            Text(
              ...
              style: TextStyle(
                ...
                fontWeight:
                    selected ? FontWeight.w600 : FontWeight.w400,
                color:
                    selected ? _kBlue : Colors.grey.shade600,
              ),
            ),
          ],
        ),
...
class _MedEntry {
  ...
  final tabletCtrl = TextEditingController(text: '1');
  ...
  static _MedEntry fromMedicine(Medicine m) {
    ...
    e.tabletCtrl.text = m.tabletCount.toString(); // non-nullable
    e.beforeMeal      = m.beforeMeal;
    e.afterMeal       = m.afterMeal;              // non-nullable
    e.morning         = m.morning;
  ...
  Medicine toMedicine() => Medicine(
        ...
        tabletCount: int.tryParse(tabletCtrl.text) ?? 1,
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount:
                patientLogs.length > 7 ? 7 : patientLogs.length,
